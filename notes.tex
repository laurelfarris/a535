...
\begin{itemize*}
    ...
    \item pupil: location where rays from all fiel angles fill the
        same aperture.
...
This pupil is generallynot accessible, so if one needs access to a pupil,
additional optics are used.
...
$$ \textrm{angular aberration} = \frac{d(2\Delta z)}{d\rho} $$
$$ \textrm{transverse aberration} = s'\frac{d(2\Delta z)}{d\rho} $$
...
\textbf{Characteristics of Two-Mirror Telescopes}
\begin{table}[h]
\centering
...
PSF = $\displaystyle
\left\vert\vphantom{FT(OTF(pupil))}\right.$FT(OTF(pupil
))$\displaystyle \left.\vphantom{FT(OTF(pupil))}\right\vert^{2}_{}$
...
PSF $\displaystyle \propto$ $\displaystyle
\left[\vphantom{{2J_1(v)\over v} - \epsilon^2{2J_1(\epsilon v)\over
\epsilon v}}\right.$$\displaystyle {2J_1(v)\over v}$ - $\displaystyle
\epsilon^{2}_{}$$\displaystyle {2J_1(\epsilon v)\over \epsilon
v}$$\displaystyle \left.\vphantom{{2J_1(v)\over v} -
\epsilon^2{2J_1(\epsilon v)\over \epsilon v}}\right]^{2}_{}$
