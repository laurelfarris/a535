...
\setlist[description]{%
    ...
    labelindent=4em,
    topsep=-1ex,
    font={\sffamily\bfseries\color{darkpowderblue}}
}
...
The meat of $r_{0}$ is in $\int\left(C_n^2\textrm{d}h\right)$;
...
{\textcolor{blue}{this plot}}.
A typical astronomical site has $r_{0} \sim$ 10 cm at 5000\AA{}.
...
(bigger $r_{0}$). 1/2' or 1' patch. Most adaptive optics in NIR\@.
